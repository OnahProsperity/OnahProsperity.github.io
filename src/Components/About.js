      ...
      <div className="container-1">
        ...
        <div className="rightside">
          ...
          <section className="about" id="about">
            ...
            <a href="https://smartswap.rigelprotocol.com/#/swap" target="_blank">
            ...
            <p className="fade">
              Rigel Protocol Special pool: where you stake your RGP token and you can refer a friend to earn more rewards
            </p>
            <a href="https://smartswap.rigelprotocol.com/#/farming-v2/staking-RGPv2" target="_blank">
              Special Pool
            </a>
            <p className="fade">
              The Rigel Protocol Collections will be unlike most NFTs we see ongoing in the Defi ecosystem. 
              As NFTs are not going to be just minted and worthless images put out there for you to hold, 
              whilst just keeping them shining in your wallets            </p>
            <a href="https://smartswap.rigelprotocol.com/#/nft" target="_blank">
              Rigel NFT
            </a>
            <p className="fade">
              Twhere bidding takes place and the top three (3) winners are qualify for reward 
              and some set of random address in the pool.      
            </p>
            <a href="https://smartswap.rigelprotocol.com/#/smartbid" target="_blank">
              smart Bid
            </a>
            <p className="fade">
              The Rigel Protocol Launchpad Platform helps innovative DeFi Projects to succeed in the highly competitive Blockchain industry
              and fund their development needs. At the same time, 
              participating projects have access to the wide platform community and full support from the Rigel Protocol team                  
            </p>
            <a href="https://launchpad.rigelprotocol.com/" target="_blank">
              Launchpad
            </a>
            <p className="fade">
              The Gift DApp is fabricated by Rigel Protocol and it comes with extremely good features. 
              The gifting system permits influencers and projects to gift/reward their fans/community in crypto.                
            </p>
          ...
          <section className="about" id="project">
            ...
            <p className="fade">
              ...
              Where reward are auto claim in different currency and Audit.
            </p>
            <a href="https://www.dexfinance.com/dexira/" target="_blank">
              DexIRA.Finance
            </a> <br/>
            <a href="https://www.dexfinance.com/wp-content/uploads/2022/01/DEXIRA-SMART-CONTRACT-SECURITY-AUDIT.pdf" target="_blank">
              DexIRA.Finance Audit
            </a> <br/>
            <p className="fade">
              Dexira Migration token from V1.
              Token migration involves balance transfers of investors from previous token in investor 
              Ethereum wallets to a new token. This happen when a token is transision to a new address 
              because bug was discovered in the previous deployment.                
            </p>
            ...
            <p className="fade">
              BSC Games promised to be a GameFi project on the Binance Smart Chain. 
              The primary aim of BSC Games is to turn gaming from just leisure activity to a cash cow by merging gaming
            ...
            - process of selling: 
                Create an account.
                Transfer your currency into a generated address specially for your account.
            ...
            <p className="fade">
              Cheetah.Finance token is a token based on the conservation of the animal kingdom. 
              Destined to Ecotourism and the conservation of cheetahs.               
            </p>
            <a href="https://tokencheetah.com/" target="_blank">
              Cheetah.finance
            </a>
            <p className="fade">
              Bida.Finance ICO contract audit              
            </p>
            <a href="https://eu.docs.wps.com/l/sALmM9UutssFV6P24hKynFA" target="_blank">
          ...
          <section className="about" id="openSource">
            ...
            <div></div>
            <p>
              My Love and passion toward Ethereum Community has driven me to contribute to Ethereum Improvement 
              Protocol (EIP) Open source 
            </p>
            <p className="fade">
              EIPs are standards specifying potential new features or processes for Ethereum,
              it contain technical specifications for the proposed changes and act as the “source of truth” for the community. 
            ...
            <p className="fade">
              Release an Open source Centralized Exchange npm package
              with the database schema to enable easy installation open for contribution            
            </p>
          ...
          <section className="about" id="education">
            ...
            <div></div>
            <p>
              I studied Software Engineering and I have performed several research projects during my undergraduate anf after.
            </p>
          </section>
          <section className="about" id="research">
            ...
            <p className="fade">
              Research on ETH Prove of work algorithm, alway join the CoreDev team weekly meeting in other to follow the Merge to POS           
            </p>
          </section>
          <section className="about" id="skills">
            ...
            <div className="Item">
              ...
              <li>EVMs supported Networks such as: Ethereum, Layer II, Binance Smart Chain, Polygon Network. E.T.C</li>
              <li>OpenZeppelin, Solidity, Web3.js, EthersJS, Truffle, Hardhat, MetaMask</li>
              <li>ERC20, ERC721, ERC1155, EIP2981, ERC1363, EIP2535, EIP-2612, ERC-4626.</li>
          ...
          <section className="about" id="interest">
            ...
            <div></div>
            <p>
            I love Footbal, music, and object-oriented programming too.
            I'm always interested in innovation regarding blockchain and innovation tools
            </p>
          </section>
